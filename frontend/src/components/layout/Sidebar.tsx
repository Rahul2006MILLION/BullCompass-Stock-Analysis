...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 apple-liquid-sidebar flex flex-col h-screen sticky top-0 z-40 select-none">
      {/* Brand Header */}
      <div className="p-6 border-b border-white/[0.08] flex items-center justify-between relative z-10">
            ...
            <Link
              ...
              className={cn(
                ...
                isActive
                  ...
                  : "text-gray-400 hover:text-gray-100 hover:bg-white/[0.08] hover:translate-x-0.5 transition-transform"
              )}
            >
              {isActive && (
                <motion.div
      ...
      <div className="p-4 border-t border-white/[0.08] space-y-3 bg-black/25 relative z-10">
        <div className="flex items-center justify-between px-2.5 py-1.5 rounded-lg bg-white/[0.05] border border-white/[0.08] backdrop-blur-sm">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-2 px-3 rounded-xl text-xs font-medium bg-[#141a24]/90 hover:bg-[#1a2230] text-gray-300 hover:text-white border border-white/10 transition-all hover:-translate-y-0.5 active:scale-[0.98] disabled:opacity-50 shadow-sm"
        >
          <RefreshCw
